...
This app makes API calls that require site owners' permission to add an embedded script to their site. This app must be configured in the Wix Dev Center to request these permissions when installed.
...
1. Click **Search by name or ID** and enter "Manage Embedded Scripts".
...
![Embedded scripts permissions](./images/permissions.png)

This scope contains the necessary permissions to add embedded scripts to the site.

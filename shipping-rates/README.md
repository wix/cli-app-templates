...
- **Web methods**: Define your own backend methods that can be called from your frontend code. Read more about [Web Methods](https://dev.wix.com/docs/build-apps/develop-your-app/frameworks/wix-cli/supported-extensions/backend-extensions/web-methods/add-web-method-extensions-with-the-cli).
...
- [Node.js](https://nodejs.org/en/) (v20.19 or higher)
